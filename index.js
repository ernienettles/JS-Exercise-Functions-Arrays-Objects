...
*/
function temperatureInF(tempNum, tempLet) {
  if (tempLet === 'F') {
    return tempNum + tempLet;
  } else if (tempLet === 'C'){
    const tempC = temperatureCtoF(tempNum) + 'F';
 ...
 * }
*/
function makePersonObject(arg1, arg2, arg3) {

  const person = {id:arg1, name:arg2, email:arg3};

  return person;
}

console.log(makePersonObject(5, 'Ernie', 'ernie@email.com'));
...
function appleIndex(array) {
 ...
 const appleIndex = array.indexOf('apple');
 return appleIndex;
}
...
function getLastCarInfo(inventory) {
  ...
  const car_info = `This is a ${car.car_make} ${car.car_model}.`
  return car_info;
}
